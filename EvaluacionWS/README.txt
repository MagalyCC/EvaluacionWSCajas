...
a persistence unit "EvaluacionWSPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWS\pom.xml":
...
artifact ("EvaluacionWS.war") is already built. You can build
